...
RcppExport SEXP gg_ld_thin_random(SEXP pASEXP, SEXP muSEXP, SEXP sdSEXP, SEXP thresholdSEXP, SEXP posSEXP, SEXP chrSEXP, SEXP max_distSEXP, SEXP begSEXP, SEXP endSEXP, SEXP w_SEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(ld_thin_random(pA, mu, sd, threshold, pos, chr, max_dist, beg, end, w_));
    return __result;
END_RCPP
}
